...
//    using SocialMedia.Services.Models.ViewModels;
...
//        private PostServiceModel Model { get; set; } = new PostServiceModel();
...
//        // GET: Posts/Create
//        public async Task<IActionResult> CreateAsync(int? groupId, string invokedFrom)
//        {
//            var viewModel = new PostViewModel()
//            {
//                CurrentUser = new UserServiceModel(
